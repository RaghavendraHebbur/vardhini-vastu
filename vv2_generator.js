...
<style>
:root{--vv-bg:#f8fafc;--vv-sf:#ffffff;--vv-bd:#e2e8f0;--vv-tx:#0f172a;--vv-tx2:#475569;--vv-tx3:#94a3b8;--vv-or:#f97316;--vv-orl:#fff7ed;--vv-orm:#ffedd5;--vv-r:16px;--vv-sh:0 1px 3px rgba(0,0,0,.05),0 4px 16px rgba(0,0,0,.03);--vv-shl:0 4px 24px rgba(0,0,0,.06),0 12px 48px rgba(0,0,0,.04);}
...
.sf{padding:80px 0;background:var(--vv-sf);border-top:1px solid var(--vv-bd);}
.sw{padding:80px 0;background:var(--vv-orl);border-top:1px solid var(--vv-orm);}
.sd{padding:80px 0;background:var(--vv-bg);border-top:1px solid var(--vv-bd);}
...
.sub{font-size:1.15rem;color:var(--vv-tx2);line-height:1.7;max-width:600px;margin:0 0 38px;}
.acts{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:52px;}
.vv2 .bp{display:inline-flex;align-items:center;gap:8px;background:var(--vv-or);color:#fff !important;padding:13px 22px;border-radius:10px;font-size:.93rem;font-weight:600;}
.vv2 .bs{display:inline-flex;align-items:center;gap:8px;background:var(--vv-sf);color:var(--vv-tx) !important;padding:13px 22px;border-radius:10px;font-size:.93rem;font-weight:600;border:1px solid var(--vv-bd);}
...
.card{background:var(--vv-sf);border:1px solid var(--vv-bd);border-radius:var(--vv-r);padding:28px;transition:transform .15s,box-shadow .15s;}
...
.ctac h2{font-size:clamp(1.75rem,4vw,2.5rem);font-weight:800;color:var(--vv-tx);letter-spacing:-.03em;margin:0 0 14px;}
.ctac p{font-size:1.05rem;color:var(--vv-tx2);margin:0 0 32px;line-height:1.6;}
.ca{display:flex;gap:12px;justify-content:center;flex-wrap:wrap;}
.vv2 .bwa{display:inline-flex;align-items:center;gap:8px;background:#25D366;color:#fff !important;padding:13px 26px;border-radius:10px;font-size:.93rem;font-weight:600;}
.vv2 .bgh{display:inline-flex;align-items:center;gap:8px;background:var(--vv-sf);color:var(--vv-tx) !important;padding:13px 26px;border-radius:10px;font-size:.93rem;font-weight:600;border:1px solid var(--vv-bd);}
...
function vv2_hero(badge, h1, sub, stats_extra = '') {
  return `<div style="background:var(--vv-bg);padding:96px 0 72px;border-bottom:1px solid var(--vv-bd);">
...
function vv2_faq(topic, faqs) {
  let html = `<section class="sf"><div class="w">
<p class="eye">FAQ</p>
...
module.exports = {
  vv2_css, vv2_hero, vv2_trust, vv2_cta, vv2_faq, vv2_wrap
};
